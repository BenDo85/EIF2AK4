# Il faut que le répertoire de travail soit EIF2AK4
# Python doit aussi être installé
...
if(.Platform$OS.type == "windows") {
  system('python.exe python_scripts\\all_gene_in_interval.py -c 15 --start 39800001 --stop 44500000 -s')
} else {
  system('python3 python_scripts/all_gene_in_interval.py -c 15 --start 39800001 --stop 44500000 -s')
}
